...
double StartAngle = 90;       //the start angle of the servo is the angle at which the beam is horizontal
...
//PID Coefficient
float Kp = 3.936;                 //Proportional coefficient
float Ki = 0.5;            //Integral coefficient
float Kd = 5.183;                 //Derivative coefficient
